...
class Vehicle(models.Model):
    ...
    type = models.CharField('Type/modell', max_length=200, null=True, blank=True, default='')
    ...
    fuel = models.CharField('Drivstoff', max_length=200, null=True, blank=True, default='')
    num_prefix = models.IntegerField('Ekstra sifer foran internnummer', blank=True, null=True)
    operator = models.ForeignKey(Operator, on_delete=models.PROTECT, verbose_name='Operatør', blank=True, null=True)
